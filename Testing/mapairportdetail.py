...
def mapper():
    index = rtree.Index()
    neighborhoods = []
    gentrified = ['Greenpoint','Chinatown','DUMBO-Vinegar Hill-Downtown','Brooklyn-Boerum Hill','East Williamsburg','Hunters Point-Sunnyside-West','Lower East Side','North Side-South Side']
